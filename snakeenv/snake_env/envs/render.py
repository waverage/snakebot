import math
import sys, pygame
from snakeenv.snake_env.envs.engine import TYPE_SNAKE, TYPE_EMPTY, TYPE_WALL, TYPE_FOOD, TYPE_SNAKE_HEAD_RIGHT, TYPE_SNAKE_HEAD_DOWN, TYPE_SNAKE_HEAD_LEFT, TYPE_SNAKE_HEAD_UP
